...
# Not sure if it still is. Just in case, we'll get it out of the way in module 1.

# Write a program to:
# - Prompt a user for a positive integer and store the result. (Could reuse a read_int method.)
